...
export function ReportModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-[var(--card-bg)] border-2 border-[var(--ink-border-heavy)] p-4 sm:p-6 shadow-[6px_6px_0px_0px_var(--shadow-color)] sm:shadow-[8px_8px_0px_0px_var(--shadow-color)] flex flex-col gap-3.5 sm:gap-4 animate-in zoom-in-95 duration-150 cursor-default"
