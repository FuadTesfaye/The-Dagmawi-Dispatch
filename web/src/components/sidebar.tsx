  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 gap-6 p-4 border-r border-zinc-800/60 min-h-[calc(100vh-4rem)] sticky top-16">
      ...
      <div className="flex flex-col gap-1.5">
        <span className="text-[11px] font-black uppercase tracking-widest text-amber-400/80 px-3 py-1">
          Kingdom Menu
        </span>
        {links.map((link) => {
          ...
          return (
            <Link
              key={link.href}
              href={link.href}
              className={`flex items-center justify-between px-4.5 py-3.5 rounded-2xl text-xs font-bold transition-all duration-200 ${
                isActive
                  ? 'bg-gradient-to-r from-amber-400 to-amber-500 text-zinc-950 shadow-lg shadow-amber-500/25 font-black scale-[1.02]'
      ...
      <div className="p-4.5 rounded-3xl glass-card bg-gradient-to-b from-amber-500/20 via-zinc-950/70 to-zinc-950 border border-amber-500/35 flex flex-col gap-3 shadow-xl royal-glow">
        ...
        <Link
          ...
          className="text-xs font-black text-amber-400 hover:text-amber-300 transition-colors inline-flex items-center gap-1 mt-1"
        >
      ...
      <div className="mt-auto p-4.5 rounded-3xl glass-card bg-zinc-950/90 border border-zinc-800 flex flex-col gap-3 text-xs shadow-lg">
        <div className="flex items-center gap-2 text-zinc-200 font-black">
        ...
        <a
          ...
          className="w-full py-2.5 px-3 text-center rounded-2xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700/80 font-extrabold text-zinc-100 transition-all shadow-sm"
        >
